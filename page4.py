...
with tab1:
    ...
    st.markdown("""
        ...
        - Хэрэв хотын сонгуульд сонгосон дөрвөн нэр дэвшигчийн **ядаж нэг нь** дүүргийн сонголттой ижил намынх байвал тухайн саналын хуудсыг **"Уялдсан"** гэж ангилав.
        - Бусад тохиолдолд **"Уялдаагүй"** гэж үзэв.
        ...
        - Зөвхөн **14.19%** тохиолдолд хот болон дүүргийн сонголтын хооронд намын зөрүү ажиглагдсан нь өөр өөр намыг хольж сонгох (split-ticket voting) үзэгдэл харьцангуй ховор байгааг илтгэнэ.
        ...
        ### Энэ яагаад чухал вэ?
        Сонгууль хоорондын намын уялдаа холбоо нь:
        - Намын харьяалал нь сонгуулийн бүх түвшинд давамгайлах хүчин зүйл хэвээр байгааг баталж байна.
        - Хотын түвшний холимог сонголт нь дүүргийн түвшинд заавал намын сонголтоо өөрчлөхөд хүргэдэггүйг харуулж байна.
