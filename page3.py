...
with tab1:
    st.markdown("""
    ### Зорилго
    Хотын сонгуульд сонгогчид **ямар нэр дэвшигчдийг нэг саналын хуудсан дээр
    хамгийн их хамтад нь сонгож байгааг** илрүүлэх.

    ---
    ### Аргачлал
    - Саналын хуудас бүр дээр сонгогдсон **4 нэр дэвшигчээс**
      бүх боломжит хослолыг үүсгэв
    ...
    - Хамт сонгогдож буй хослолууд нь **намаар бүлэглэн санал өгөх**
      (slate voting) зан төлөв давамгай байгааг харуулж байна
...
with tab2:
    ...
    энд илэрч буй хослолууд нь **шууд хамтын сонголтыг**
    хамгийн цэвэр байдлаар илэрхийлнэ.
    """)
...
with tab3:
    ...
    **нарийвчлан задлан шинжлэх**.
    ...
    - Энэ дүүрэгт сонгогчид **ямар хоёр нэр дэвшигчийг**
      хамгийн тогтмол хамтад нь сонгосныг харуулна
    - Дүүрэг бүрт хамтын сонголтын **онцлог хэв маяг**
      өөр өөр байгааг ажиглах боломжтой
    """)
